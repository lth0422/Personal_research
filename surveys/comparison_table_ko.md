...
| Bhaventhan et al., Vibration PdM Edge AI | 2026 | BLDC motor multi-class FD | Raspberry Pi 4 | OS 세부 미명시 | 확인 불가 (카드 세부 정보 부족) | low latency라고 서술 | 수치 timing/W/H가 없어 실시간성 근거 약함; `B` | Pi/Linux FD background, 직접 timing 비교에는 부적합 |
